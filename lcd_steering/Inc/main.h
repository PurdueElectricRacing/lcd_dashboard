...
#define StartButton_DB_Pin GPIO_PIN_4
#define StartButton_DB_GPIO_Port GPIOA
#define StartButton_DB_EXTI_IRQn EXTI4_IRQn
...
#define VCAN_RX_Pin GPIO_PIN_11
...
#define BTN3_IC_Pin GPIO_PIN_7
#define BTN3_IC_GPIO_Port GPIOB
#define BTN3_IC_EXTI_IRQn EXTI9_5_IRQn
